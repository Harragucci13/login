 ...
 * @author issa
 */
public class Keicy extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Keicy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
